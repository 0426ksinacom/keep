package com.demoapplication.ui;
...
import com.demoapplication.uitil.LogMy;
import com.demoapplication.view.KeepActivity;

import java.io.FileNotFoundException;
import java.io.IOException;
//SurfaceView  TextureVideoView  implements TextureView.SurfaceTextureListener
...
//    private SurfaceHolder mSurfaceHolder = null;
    ...
    //////////>
    @Override
    public void onSurfaceTextureAvailable(SurfaceTexture ssurface, int width, int height) {

//防止出现      surface  没有准备好就播放
        boolean needReOpen = (surface == null);
        surface = ssurface;
        if (needReOpen) {
            reOpen();
        }
    ...
    @Override
    public void onSurfaceTextureSizeChanged(SurfaceTexture ssurface, int width, int height) {
        LogMy.info("onSurfaceTextureSizeChanged");
    }

    @Override
    public boolean onSurfaceTextureDestroyed(SurfaceTexture ssurface) {
        LogMy.info("onSurfaceTextureDestroyed");
        surface = null;
        release();
        return true;
    }
...
//    }
    ...
    public void openVideo(String uri) {
        ...
        if (uri == null || surface == null || getContext() == null) {
...
//                mMediaPlayer =   MediaPlayer.create( getContext(),mUri);
            ...
            AssetFileDescriptor fileDescriptor =  getContext().getAssets().openFd(uri);
